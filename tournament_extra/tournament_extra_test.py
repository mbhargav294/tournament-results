...
def testCount():
    ...
    """
    deleteMatches(TOUR_ID)
    deletePlayers(TOUR_ID)
    c = countPlayers(TOUR_ID)
    if c == '0':
        raise TypeError(
...
def testStandingsBeforeMatches():
    ...
    deleteMatches(TOUR_ID)
    deletePlayers(TOUR_ID)
    registerPlayer(TOUR_ID, "Melpomene Murray")
    registerPlayer(TOUR_ID, "Randy Schwartz")
...
def testReportMatches():
    ...
    deleteMatches(TOUR_ID)
    deletePlayers(TOUR_ID)
    registerPlayer(TOUR_ID, "Bruno Walton")
    registerPlayer(TOUR_ID, "Boots O'Neal")
    registerPlayer(TOUR_ID, "Cathy Burton")
    registerPlayer(TOUR_ID, "Diane Grant")
    standings = playerStandings(TOUR_ID)
    [id1, id2, id3, id4] = [row[1] for row in standings]
    reportMatch(TOUR_ID, id1, id2)
    reportMatch(TOUR_ID, id3, id4)
    standings = playerStandings(TOUR_ID)
...
def testPairings():
    ...
    deleteMatches(TOUR_ID)
    deletePlayers(TOUR_ID)
    registerPlayer(TOUR_ID, "Twilight Sparkle")
    registerPlayer(TOUR_ID, "Fluttershy")
    registerPlayer(TOUR_ID, "Applejack")
    registerPlayer(TOUR_ID, "Pinkie Pie")
    registerPlayer(TOUR_ID, "Rarity")
    registerPlayer(TOUR_ID, "Rainbow Dash")
    registerPlayer(TOUR_ID, "Princess Celestia")
    registerPlayer(TOUR_ID, "Princess Luna")
    standings = playerStandings(TOUR_ID)
    [id1, id2, id3, id4, id5, id6, id7, id8] = [row[1] for row in standings]
    pairings = swissPairings(TOUR_ID)
    if len(pairings) != 4:
        raise ValueError(
            "For eight players, swissPairings should return 4 pairs. Got {pairs}".format(pairs=len(pairings)))
    reportMatch(TOUR_ID, id1, id2)
    reportMatch(TOUR_ID, id3, id4)
    reportMatch(TOUR_ID, id5, id6)
    reportMatch(TOUR_ID, id7, id8)
    pairings = swissPairings(TOUR_ID)
    if len(pairings) != 4:
        raise ValueError(
            "For eight players, swissPairings should return 4 pairs. Got {pairs}".format(pairs=len(pairings)))
...
if __name__ == '__main__':
    TOUR_ID = createNewTournament('Football')
    testCount()
